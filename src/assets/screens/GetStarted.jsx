  ...
  items-center justify-center '>
      ...
      <section className='flex justify-around items-center px-48 py-10'>
        ...
        <div className='bg-gray-500 rounded-2xl w-70 h-72 '>
          <div className='justify-center items-center py- relative overflow-hidden shadow-lg hover:scale-105 transition duration-300'>
        ...
        <div className='bg-gray-500 rounded-2xl w-70 h-72'>
          <div className='justify-center items-center  relative overflow-hidden shadow-lg hover:scale-105 transition duration-300'>
