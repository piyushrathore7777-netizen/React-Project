  ...
  items-center justify-center '>
      ...
      <section className="flex items-center justify-evenly mt-10">
        <div className="flex justify-evenly  mt-4 space-x-10">
          <div className="py-22">
            <p className="text-5xl font-bold">Over 780,000 men</p>
            <p className="text-2xl font-semibold ">in their 30s have already tried our <br /> Calisthenics Workout Plan</p>

          </div>

          <div className="justify-around items-center h-15 ">
      ...
      <section className="justify-around items-center py-23">
        <div>
          <hr></hr>
        </div>
