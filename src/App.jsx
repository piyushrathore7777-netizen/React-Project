...
function App() {
  ...
  return ( 
    ...
    <div className="absolute flex justify-around items-center space-x-72 px-20">
      <div>
        <p className="text-4xl font-semibold"> BetterMe</p>
      </div>
    ...
    <section className="absolute px-19 py-80 gap-4">
      ...
      <p className="py-10">
     <button className="bg-white text-black rounded-full h-12 w-40">Get Started</button>
     </p>
 */}
    ...
    <Home></Home>
    <Routes>
      <Route path='/' element={<GetStarted></GetStarted>} />
    </Routes>
    </BrowserRouter> */}
    {/* </section> */}
